...
// এই ফাংশনটি কার্ডে ক্লিক করলে নতুন ট্যাবে ছবি ও মেসেজ দেখাবে।
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .img-container {
          ...
          background-color: #f0f0f0; /* ছবি না থাকলে গ্রে ব্যাকগ্রাউন্ড দেখাবে */
          display: flex;
          justify-content: center;
          align-items: center;
          color: #888;
    ...
    <body>
      <div class="card">
        ...
        <div class="img-container">
          <!-- যদি ছবি না পাওয়া যায়, তবে "Image Preview" লেখা দেখাবে -->
          <img src="${imgSrc}" alt="${title}" onerror="this.style.display='none'; this.parentNode.innerHTML='Image Preview'">
        </div>
